<?php
// source: C:\wamp64\www\minizelen\app/config/common.neon
// source: C:\wamp64\www\minizelen\app/config/local.neon
// source: array
...
class Container_cca2e0d75e extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'application.1' => true,
	...
	protected $wiring = [
		...
		'App\Presenters\ProductsPresenter' => [2 => ['application.4']],
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\wamp64\www\minizelen\app',
			'wwwDir' => 'C:\wamp64\www\minizelen\www',
			'vendorDir' => 'C:\wamp64\www\minizelen\vendor',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\wamp64\www\minizelen\app/../temp',
		];
	}
	...
	public function createServiceApplication__4(): App\Presenters\ProductsPresenter
	{
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\wamp64\www\minizelen\app/../temp/cache/nette.application/touch'));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\wamp64\www\minizelen\app/../temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\IStorage
	{
		return new Nette\Caching\Storages\FileStorage('C:\wamp64\www\minizelen\app/../temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_cca2e0d75e
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_cca2e0d75e $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\wamp64\www\minizelen\app/../temp/cache/latte');
