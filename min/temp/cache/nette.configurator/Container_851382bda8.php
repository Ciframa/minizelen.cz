...
class Container_851382bda8 extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'application.1' => true,
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'wwwDir' => '/hosting/www/minizelen.cz/www',
	...
	public function createServiceContainer(): Container_851382bda8
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_851382bda8 $container)
			{
