<?php
// source: /hosting/www/minizelen.cz/min/app/config/common.neon
// source: /hosting/www/minizelen.cz/min/app/config/local.neon
// source: array
...
class Container_2bbefea284 extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'application.1' => true,
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => '/hosting/www/minizelen.cz/min/app',
			'wwwDir' => '/hosting/www/minizelen.cz/min/www',
			'vendorDir' => '/hosting/www/minizelen.cz/min/vendor',
			'debugMode' => false,
			'productionMode' => true,
			'consoleMode' => false,
			'tempDir' => '/hosting/www/minizelen.cz/min/app/../temp',
		];
	}
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('/hosting/www/minizelen.cz/min/app/../temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\IStorage
	{
		return new Nette\Caching\Storages\FileStorage('/hosting/www/minizelen.cz/min/app/../temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_2bbefea284
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=minizelencz1', 'minizelen.cz', 'tRrTcqR3EMcf', []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_2bbefea284 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/hosting/www/minizelen.cz/min/app/../temp/cache/latte');
